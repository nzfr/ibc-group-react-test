...
const Topbar = ({view, setView, setIsFiltered, isFiltered}) => {
    ...
    return (
        <div className="flex flex-col ">
            ...
            <CreateUser open={showEmployeeTopBar ? open : false} scroll={scroll} setOpen={setOpen}/>
            <CreateClient open={showClientTopBar ? open : false} scroll={scroll} setOpen={setOpen}/>
